...
CREATE OR REPLACE VIEW rass.dd65 AS 
 SELECT hdd65.t24cz,
   ...
   FROM ( SELECT ddn_electricbillingdatamodels.t24cz,
          ...
          WHERE ddn_electricbillingdatamodels.heatref = 65 AND ddn_electricbillingdatamodels.t24cz > 1 OR ddn_electricbillingdatamodels.heatref >= 64 AND ddn_electricbillingdatamodels.heatref <= 66 AND ddn_electricbillingdatamodels.t24cz = 1
    ...
    ( SELECT ddn_electricbillingdatamodels.t24cz,
            avg(ddn_electricbillingdatamodels.hddnorm) AS hddnorm
           FROM rass.ddn_electricbillingdatamodels
          WHERE ddn_electricbillingdatamodels.heatref = 72 AND ddn_electricbillingdatamodels.t24cz > 1 OR ddn_electricbillingdatamodels.heatref = 71 AND ddn_electricbillingdatamodels.t24cz = 1
          GROUP BY ddn_electricbillingdatamodels.t24cz
